...
//     webClientId: '183526783987-jv11p7tsa0jib0juqdvnlak9k1pubhbk.apps.googleusercontent.com',
//     offlineAccess:true
// });
...
export const AuthProvider = ({children}: any) => {
    ...
    const signUp = async({correo,nombre,password}: RegisterData) => {
        ...
        try {
            ...
            const {data} = await authApi.post<LoginResponse>('/usuarios',{
                nombre,
                correo,
                password,
                rol:'USER_ROLE'
    ...
    //         const resp = await authApi.post<LoginResponse>('/auth/facebook',data);
